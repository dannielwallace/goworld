...
// 使用方法可以参考：https://github.com/dannielwallace/goworld/blob/master/examples/unity_demo/unity_demo.go
...
// https://github.com/dannielwallace/goworld/blob/master/examples/unity_demo/unity_demo.go
func Run() {
	game.Run()
}
